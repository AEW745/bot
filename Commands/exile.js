...
module.exports = {
    ...
    .addStringOption(option =>
        ...
        async slashexecute(bot, interaction) {
            ...
            let logssetup = bot.db.get(`LogsSetup_${interaction.guild.id}`)
            await interaction.deferReply({ephemeral: true});
            if (!serversetup && logssetup) return interaction.editReply(`:x: **ERROR** | This server hasn't been setup. Please ask the Owner to setup the bot for this server!`)
            ...
            try {
                ...
                let serverlogs = bot.db.get(`LogsSetup_${interaction.guild.id}.serverlogs`)
